  ...
  @RequestMapping("/dd")
    ...
    System.out.println(tel);
      ...
      // TODO 此处需要替换成开发者自己的AK(在阿里云访问控制台寻找)
       String accessKeyId = "LTAI4GCxcdGFY3G91qTP58MU";           // TODO 改这里
      String accessKeySecret = "yZDvHIUTIyZe4QLSwAYv2XUDVWGiK1"; // TODO 改这里
        ...
        // 必填:短信签名-可在短信控制台中找到
        request.setSignName("小小果实"); // TODO 改这里
        // 必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_202355464");  // TODO 改这里
